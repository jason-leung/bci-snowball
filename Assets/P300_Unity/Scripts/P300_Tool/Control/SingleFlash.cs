...
public class SingleFlash : MonoBehaviour
{
    ...
    IEnumerator SingleFlashCor()
    {
        ...
        while (startFlashes)
        {
            ...
            if (flash_counter[randomCube] > 0)
            {
                ...
                p300_Controller.TurnOnObject(randomCube);
        ...
        startFlashes = !startFlashes;
        p300_Controller.LockKeysToggle(KeyCode.P);//keyLocks[KeyCode.S] = !keyLocks[KeyCode.S];
    ...
    {
        for (int i = 0; i < p300_Controller.object_list_p1.Count; i++)
        {
            p300_Controller.TurnOffObject(i);
        }
    }
    ...
    public void Redraw()
    {
        ...
        TurnOffSingle();
        ResetSingleCounters();
        p300_Controller.object_list_p1.Clear();
        p300_Controller.object_list_p2.Clear();
        SetUpSingle();
    }
